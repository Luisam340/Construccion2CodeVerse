...
public class AdministrativeStaffUseCase {
    ...
    public AdministrativeStaffUseCase(RegisterPatient registerPatient, RegisterEmergencyContact registerEmergencyContact, RegisterPolicy registerPolicy) {
        this.registerEmergencyContact = registerEmergencyContact;
    ...
    public void createPatient(Patient patient, EmergencyContact emergencyContact, Policy policy) throws Exception {
        patient.setType(PersonType.PATIENT.getPersonType());
